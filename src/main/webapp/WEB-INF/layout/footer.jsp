...
<!-- ALL PLUGINS -->
<script src="<c:url value="/js/jquery.superslides.min.js" />"></script>
<script src="<c:url value="/js/bootstrap-select.js" />"></script>
<script src="<c:url value="/js/inewsticker.js" />"></script>
<script src="<c:url value="/js/bootsnav.js" />"></script>
<script src="<c:url value="/js/images-loded.min.js" />"></script>
<script src="<c:url value="/js/isotope.min.js" />"></script>
<script src="<c:url value="/js/owl.carousel.min.js" />"></script>
<script src="<c:url value="/js/baguetteBox.min.js" />"></script>
